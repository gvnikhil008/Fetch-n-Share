...
<body id="top">
  ...
  <nav id="mainav" class="hoc clear"> 
    <ul class="clear" style="float: center">
      ...
      <li class="active"><a style="text-decoration: none;" href="Cfile.jsp">Cloud Files</a></li>
...
try
{
	 con = DbConnection.getConnection();
        String qry="select fid,name,fname,size from filedetails";
