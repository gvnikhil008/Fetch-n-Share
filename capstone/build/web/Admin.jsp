  ...
  <nav id="mainav" class="hoc clear"> 
    <ul class="clear" style="float: center">
      ...
      <li class="active"><a href="Admin.jsp">Admin</a></li>
       ...
       <div style="background-image: url(images/admin.png); background-repeat:no-repeat; background-position:center; background-size:cover;">
    <div>
        <center> <br> <br><br><br>
            <h1 style="color:whitesmoke"></h1> <br> <div class="wrap-login100" >
             <form id="verify" action="Adminverify.jsp" method="post">
