<%-- 
    Document   : osignup
    Created on : Oct 23, 2020, 12:48:20 PM
    Author     : Datapoint
--%>
...
String service="not yet";
  String sharedkey = "Not Allocated";
...
con=DbConnection.getConnection();
 String qry="insert into ownerreg(name,password,email,gender,mobile,state,sharedkey,service)values(?,?,?,?,?,?,?,?)";
...
int row=ps.executeUpdate();
    if (row > 0) { 
        ...
        response.sendRedirect("Ownesginup.jsp?msg=already");
        e.printStackTrace();
        }
%>
</html>
