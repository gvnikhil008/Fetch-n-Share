...
<body id="top">
  ...
  <nav id="mainav" class="hoc clear"> 
     <ul class="clear" style="float: center">
      <li   class="active" ><a style="text-decoration: none;" href="AdminHome.jsp">Home</a></li>
      ...
      <li><a style="text-decoration: none;" href="Admin.jsp">Logout</a></li>
       ...
       <div style="background-image: url(images/admin.png); background-repeat:no-repeat; background-position:center; background-size:cover;"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    <div>
  ...
  <div id="copyright" class="hoc clear"> 
    ...
    <p class="fl_left">Copyright &copy; 2020 - All Rights Reserved - <a href="index.html">EMRSMCA</a></p>
