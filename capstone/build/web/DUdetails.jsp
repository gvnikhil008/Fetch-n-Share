...
<body id="top">
  ...
  <nav id="mainav" class="hoc clear"> 
    <ul class="clear" style="float: center">
      ...
      <li><a style="text-decoration: none;" href="Accesskey.jsp">Data Owner</a></li>
      <li  class="active" ><a style="text-decoration: none;" href="DUdetails.jsp">Data User</a></li>
      ...
      <li><a style="text-decoration: none;" href="Admin.jsp">Logout</a></li>
       ...
       <div style="background-image: url(images/y.png); background-repeat:no-repeat; background-position:center; background-size:cover;"><br><br><br>
    <div>
						...
						<thead>
							<tr class="table100-head">
								...
								<th class="column2">Email</th>
                                                                <th class="column5">Owner Name</th>
                                                        </tr>
						</thead>
                                                 <%
...
try
{
	 con = DbConnection.getConnection();
        String qry="select userId,name,email,ownername from userreg";
