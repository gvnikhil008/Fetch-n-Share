  ...
  <nav id="mainav" class="hoc clear">   
    <ul class="clear" style="float: center">
     ...
     <li><a style="text-decoration: none;" href="osignin.jsp">Logout</a></li>
        ...
        <center> <br> <br><br><br>
            <h1 style="color:black">Request Accept</h1> <br> <div class="wrap-login100" > 
</div>
    <div class="limiter">
		<div class="container-table100">
			...
			String rstatus="no",raowner=(String)session.getAttribute("name"),rowner=null;
...
try
{
	 con = DbConnection.getConnection();
        String qry="select rid,rowner,requestedspace from reqspace where raowner='"+raowner+"' and requestedStatus='"+rstatus+"'";
